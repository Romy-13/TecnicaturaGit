...
public class ProyectoPrueba {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            int opc = 0;
            scanner.nextLine(); // Limpiar el búfer de entrada después de leer un número.
            

            switch (opc) {
                case 1 ->
                    PiedraPapelTijera.main(null); // Llama al juego Piedra, Papel o Tijera
                
                case 2 ->
                    Tateti.main(null); // Llama al juego Tateti
                
                case 3 ->
                    Ahorcado.main(null); // Llama al juego Ahorcado
                   
                case 4 ->
                    AdivinaLaPalabra.main(null); // Llama al juego Adivina la Palabra
                 
                case 5 ->
                    JuegoMemoria.main(null); // Llama al juego Memoria
            ...
            if (scanner.hasNext()) {
                respuesta = scanner.next(); // Lee la respuesta del usuario
            } else {
                respuesta = ""; // Si no hay respuesta, se inicializa como cadena vacía
            }
            System.out.println();
            scanner.nextLine(); // Limpiar el búfer de entrada después de la respuesta
